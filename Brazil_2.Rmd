...
```{r}
ggplot(brazil_cities_region, aes(x= region_days_since_10000_cases, y= cumsum_region, color=region))+ geom_point()

ggplot(brazil_cities_type, aes(x= city_type_days_since_10000_cases, y= cumsum_city_type, color=city_type))+ geom_point()

ggplot(brazil_cities_states, aes(x= states_days_since_10000_cases, y= cumsum_states, color=state))+ geom_point()

ggplot(brazil_cities_gdp, aes(x= gdp_days_since_10000_cases, y= cumsum_gdp, color=gdp_group))+ geom_point()
...
brazil_new_cases %>% tidy(conf.int=TRUE) 
