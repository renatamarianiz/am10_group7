...
#Creating new df per region (5 regions in Brazil)
brazil_cities_region <- 
  brazil_cities %>%
  arrange(region, date) %>% 
...
#Creating new df per type of city (summarising information per city type)
...
#Creating new df for the GDP - creating new column to classify the GDP per Capita
...
#Creating new df and grouping by gdp group
brazil_cities_gdp <- brazil_cities_gdp %>%
...
#Creating new df and grouping by gdp group - cases per population
